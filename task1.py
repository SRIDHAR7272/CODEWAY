...
def add_task(tasks, description, due_date):
    tasks.append({"description": description, "due_date": str(due_date)})
...
def update_task(tasks, index):
    if 1 <= index <= len(tasks):
        ...
        updated_due_date = input("Enter the updated due date: ")
        tasks[index - 1]["description"] = updated_description
        tasks[index - 1]["due_date"] = updated_due_date
